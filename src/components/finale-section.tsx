        ...
        <AnimatePresence>
          {showEnding && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 z-[99999] flex flex-col items-center justify-center min-h-[100dvh] bg-black/95 backdrop-blur-lg px-4 text-center overflow-hidden"
            >
              {/* Ambient background particles/stars */}
              <div className="absolute inset-0 pointer-events-none opacity-20 bg-[radial-gradient(#ffd700_1px,transparent_1px)] [background-size:20px_20px] animate-pulse" />

              <div className="max-w-3xl mx-auto flex flex-col items-center justify-center relative min-h-[400px] z-10">
                <AnimatePresence mode="wait">
                  <motion.div
                    key={endingIndex}
